    ...
    public partial class Form1 : Form
    {
        ...
        private void btnExpenses_Click(object sender, EventArgs e)
        {
            ...
            if (IsValidAmountInput())
            {
                ...
                Expenses newExpenses = new Expenses(categories, amount, date, selectedDescription);
        ...
        private void UpdateDescriptionComboBox()
        {
            ...
            {
                // Flag to handle the first iteration in the loop.
                ...
                {
                    // Skip the first iteration to avoid adding an empty item.
                    if (!firstInteration)
                    {
        ...
        /// <summary>
        /// Initializes the balance text box if not set.
        /// </summary>
        private void InitializeBalance()
        {
            // Check if the initial balance has not been set.
            if (!isInitialBalanceSet)
            {
                // Set the initial balance text.
                txtBalance.Text = "Bilance: 0";
                // Mark the initial balance as set.
        ...
        private void AddTransactionRow(Transaction transaction)
        {
            ...
            row.CreateCells(dgvHistory, type, amount.ToString("C2", new System.Globalization.CultureInfo("cs-CZ")), date, category, description);
        ...
        private void btnDeleteTransaction_Click(object sender, EventArgs e)
        {
            ...
            if (dgvHistory.SelectedRows.Count > 0)
            {
                ...
                // Check if the selected row represents a transaction.
